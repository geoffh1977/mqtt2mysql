...
MYSQL_USER = os.getenv('MYSQL_USER', 'mqtt')
MYSQL_PASSWORD = os.getenv('MYSQL_PASSWORD', 'mqtt')
MYSQL_DB = os.getenv('MYSQL_DB', 'mqtt')
...
def on_message(mosq, obj, msg):
  ...
  cursor.execute("SELECT topic_id, topic FROM topics WHERE topic=\"" + msg.topic + "\";")
  ...
  cursor.execute("INSERT INTO data(value_timestamp,value,topic_id) VALUES (now(3),\"" + msg.payload.decode() + "\"," + str(topic_id) + ");")
